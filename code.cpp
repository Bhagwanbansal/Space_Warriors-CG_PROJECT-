...
void introScreen()
{
	...
	displayRasterText(-125, 225, 0.0,"Space Warriors");
   		glColor3f(1.0, 0.7, 0.8);
	displayRasterText(-100, 150, 0.0,"created by");
		glColor3f(1.0, 1.0, 1.0);
	 displayRasterText(-130, 80, 0.0,"MAFIA'S");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -285, 0.0," Bhagwan Bansal 101903015");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Dr. Kuntal Chowdhury");
		glColor3f(1.0, 0.0, 0.0);
...
void keyOperations() {
	...
	if(viewPage == GAME) {
		...
		if(keyStates['c'] == true) {
			...
			laser2 = false;
			if(keyStates['d'] == true) xTwo-=SPACESHIP_SPEED; // d to move left
			if(keyStates['a'] == true) xTwo+=SPACESHIP_SPEED; // a move right
		...
		if(keyStates['m'] == true) {
			...
			laser1 = false;
			if(keyStates['l'] == true) xOne+=SPACESHIP_SPEED;  // l to move right
			if(keyStates['j'] == true) xOne-=SPACESHIP_SPEED; // j move left
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Space Warriors");
    init();
